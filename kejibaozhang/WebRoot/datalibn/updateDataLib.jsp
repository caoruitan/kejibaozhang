            ...
            <form class="form-horizontal" action="#" method="post" name="updateDataLibForm" id="updateDataLibForm" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	<select id='thinKind' name="thinKind">
                                ...
                                <c:if test="${dataLib.thinKind eq '碳纳米管' }">
	                                <option value="煤">煤</option>
	                                <option value="稻壳">稻壳</option>
	                                <option value="药渣">药渣</option>
	                                <option value="矿物盐">矿物盐</option>
	                                <option value="石油">石油</option>
	                                <option value="碳纳米管" selected="selected">碳纳米管</option>
	                                <option value="类金刚石薄膜">类金刚石薄膜</option>
	                                <option value="氟碳薄膜">氟碳薄膜</option>
	                                <option value="其他">其他</option>
                                </c:if>
                                <c:if test="${dataLib.thinKind eq '类金刚石薄膜' }">
	                                <option value="煤">煤</option>
	                                <option value="稻壳">稻壳</option>
	                                <option value="药渣">药渣</option>
	                                <option value="矿物盐">矿物盐</option>
	                                <option value="石油">石油</option>
	                                <option value="碳纳米管">碳纳米管</option>
	                                <option value="类金刚石薄膜" selected="selected">类金刚石薄膜</option>
	                                <option value="氟碳薄膜">氟碳薄膜</option>
	                                <option value="其他">其他</option>
                                </c:if>
                                <c:if test="${dataLib.thinKind eq '氟碳薄膜' }">
	                                <option value="煤">煤</option>
	                                <option value="稻壳">稻壳</option>
	                                <option value="药渣">药渣</option>
	                                <option value="矿物盐">矿物盐</option>
	                                ...
	                                <option value="碳纳米管">碳纳米管</option>
	                                <option value="类金刚石薄膜">类金刚石薄膜</option>
	                                <option value="氟碳薄膜" selected="selected">氟碳薄膜</option>
	                                <option value="其他">其他</option>
                                </c:if>
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	<select id='catalystKind' name="catalystKind">
                                <c:if test="${dataLib.catalystKind eq '催化剂种类1' }">
	                                <option value="催化剂种类1" selected="selected">催化剂种类1</option>
                                	<option value="催化剂种类2">催化剂种类2</option>
                                </c:if>
                                <c:if test="${dataLib.catalystKind eq '催化剂种类2' }">
	                                <option value="催化剂种类1">催化剂种类1</option>
                                	<option value="催化剂种类2" selected="selected">催化剂种类2</option>
                                </c:if>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	<c:if test="${empty dataLib.reactiont }">
                            	<input id="reactiont" name="reactiont" type="text" placeholder="反应温度" />
                        	</c:if>
                        	<c:if test="${not empty dataLib.auraRate }">
                            	<input id="reactiont" name="reactiont" type="text" value="<fmt:formatNumber value="${dataLib.reactiont}" pattern="#,##0.#"></fmt:formatNumber>"/>
                        	</c:if>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	...
                        	<c:if test="${not empty dataLib.auraRate }">
                            	<input id="reactionTime" name="reactionTime" type="text" value="<fmt:formatNumber value="${dataLib.reactionTime}" pattern="#,##0.#"></fmt:formatNumber>"/>
                        	</c:if>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	...
                        	<c:if test="${not empty dataLib.auraRate }">
                            	<input id="negativePressure" name="negativePressure" type="text" value="<fmt:formatNumber value="${dataLib.negativePressure}" pattern="#,##0.#"></fmt:formatNumber>"/>
                        	</c:if>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	...
                        	<c:if test="${not empty dataLib.auraRate }">
                            	<input id="forwardPressure" name="forwardPressure" type="text" value="<fmt:formatNumber value="${dataLib.forwardPressure}" pattern="#,##0.#"></fmt:formatNumber>"/>
                        	</c:if>
                        </div>
                    </div>
                </fieldset>
