                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input name="lx" type="radio"> 煤
                            </label>
                            <label class="checkbox inline">
                                <input name="lx" type="radio"> 稻壳
                            </label>
                            <label class="checkbox inline">
                                <input name="lx" type="radio"> 中药渣
                            </label>
                            <label class="checkbox inline">
                            ...
                            <label class="checkbox inline">
                                <input name="lx" type="radio"> 乙醇
                            </label>
                            <label class="checkbox inline">
                                <input name="lx" type="radio"> 煤油
                            </label>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">密度</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">比热容</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">蒸发热</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">分子量</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">粘度</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="wxcs">沸点</label>
                        <div class="controls">
                            <input id='wxcs' name="wxcs" type="text"/>
                        </div>
                    </div>
