...
<script type="text/javascript">
    $(document).ready(function(){
        // 添加用户表单验证
        $('#updateLoginInfoForm').validate({
            submitHandler : function() {
                $.ajax({
                    type : 'POST',
                    url : '${basePath}/user/updateUser.action',
                    data : $("#updateLoginInfoForm").serialize(),
                    dataType : 'json',
                    success : function() {
                        $("#updateLoginInfoModal").modal('hide');
                    }
                });
            },
            rules: {
...
<body>
    <form class="form-horizontal" method="post" action="<%=basePath%>/user/updateUser.action" name="updateLoginInfoForm" id="updateLoginInfoForm">
