...
<c:forEach var="dataLib" items="${gridData.list}" varStatus="status">
    <tr>
        ...
        <td>${dataLib.catalystKind}</td>
        <td><fmt:formatNumber value="${dataLib.reactiont}" pattern="#,##0.#"></fmt:formatNumber></td>
        <td><fmt:formatNumber value="${dataLib.reactionTime}" pattern="#,##0.#"></fmt:formatNumber></td>
        <td><fmt:formatNumber value="${dataLib.negativePressure}" pattern="#,##0.#"></fmt:formatNumber></td>
        <td><fmt:formatNumber value="${dataLib.forwardPressure}" pattern="#,##0.#"></fmt:formatNumber></td>
